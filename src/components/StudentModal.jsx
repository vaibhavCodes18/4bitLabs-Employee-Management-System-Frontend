...
export const StudentModal = ({ title, formData, onChange, onSubmit, onClose, submitText }) => (
        ...
        <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md p-6 animate-scale-in border border-gray-100">
            ...
            <form onSubmit={(e) => { e.preventDefault(); onSubmit(); }} className="space-y-4">
                ...
                <div>
                    ...
                    <select name="status" value={formData.status || "active"} onChange={onChange}
                        className="w-full px-4 py-2.5 border border-gray-200 rounded-xl text-sm bg-gray-50 focus:bg-white focus:ring-2 focus:ring-amber-200 focus:border-amber-400 transition">
                ...
                <div className="flex justify-end gap-3 pt-4 border-t border-gray-100">
                    ...
                    <button type="submit" className="px-5 py-2.5 bg-linear-to-r from-amber-600 to-orange-600 text-white rounded-xl text-sm font-medium hover:shadow-lg hover:shadow-amber-200 transition-all duration-200">
                        {submitText}
                    </button>
                </div>
            </form>
