...
const ViewEmployeeModal = ({ isOpen, employee, role, onClose }) => {
    ...
    const roleGradients = {
        Trainer: "from-emerald-500 to-teal-600",
        Analyst: "from-purple-500 to-pink-600",
        ...
        <div className="fixed inset-0 bg-black/40 backdrop-blur-sm flex items-center justify-center z-50 p-4 animate-fade-in">
            <div className="bg-white rounded-2xl shadow-2xl w-full max-w-3xl max-h-[90vh] overflow-y-auto animate-scale-in border border-gray-100">
                ...
                <div className="border-t border-gray-100 p-4 flex justify-end">
                    <button type="button" onClick={onClose} className="px-5 py-2.5 bg-gradient-to-r from-indigo-500 to-indigo-600 text-white rounded-xl hover:shadow-lg hover:shadow-indigo-200 text-sm font-medium transition-all duration-200">
                        Close
                    </button>
                </div>
            </div>
