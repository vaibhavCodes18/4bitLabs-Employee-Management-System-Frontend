          ...
          <tbody>
            {analysts.map((analyst) => (
              <tr key={analyst.id} className="border-b hover:bg-gray-50">
                <td className="py-3 font-medium whitespace-nowrap">{analyst.name}</td>
                <td className="py-3 whitespace-nowrap">{analyst.email || '-'}</td>
                <td className="py-3 whitespace-nowrap">{analyst.phno || '-'}</td>
                <td className="py-3 whitespace-nowrap">{analyst.department}</td>
                <td className="py-3 whitespace-nowrap">{analyst.joiningdate || '-'}</td>
                <td className="py-3 whitespace-nowrap">${analyst.salary?.toLocaleString() || '-'}</td>
