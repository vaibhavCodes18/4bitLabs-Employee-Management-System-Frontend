...
const AddEmployeeModal = ({ isOpen, onClose, role, formData, onChange, onSubmit }) => {
      ...
      case 'Counsellor':
        return (
          <>
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">Students Assigned</label>
              <input
                type="number"
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">Satisfaction (0-5)</label>
              <input
                type="number"
                step="0.1"
                min="0"
