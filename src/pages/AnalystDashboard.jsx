...
const AnalystDashboard = () => {
  ...
  const handleAddBatch = async () => {
    try {
      ...
      toast.success("Batch added successfully!", successToastStyle);
      closeModals();
    } catch (err) {
  ...
  const handleEditBatch = async () => {
    try {
      ...
      tosts.success("Batch updated successfully!", successToastStyle);
      closeModals();
    } catch (err) {
      tosts.error("Failed to update batch. Please try again.");
      console.error(err);
    }
  };
  ...
  const handleDeleteBatch = async () => {
    try {
      ...
      tosts.success("Batch deleted successfully!", successToastStyle);
      closeModals();
    } catch (err) {
      tosts.error("Failed to delete batch. Please try again.");
      console.error(err);
    }
  };
        ...
        <div className="p-6">
          {activeView === "dashboard" && (
            <>
              ...
              {/* Recent Batches Table (commented out in original, keep as is) */}
            </>
          )}
